...
export const FILUR_UNLOCKABLES = [
    "TOKEN_OUTFIT_REWARD_HERO_FILUR_OUTBREAK",
    "FIREARMS_HERO_PISTOL_FILUR",
    "TOKEN_PROP_MELEE_SICKLE_FILUR",
    "TOKEN_PROP_TOOL_KEYCARD_HACKER_FILUR",
]
